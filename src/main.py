...
def main() -> None:
    ...
    parser.add_argument('-r', '--room', type=int, default=148, help='Room number')
    parser.add_argument('-d', '--debug', action='store_true', help='Enable debug mode')
    parser.add_argument('-x', type=float, default=20, help='Hero starting X position')
    parser.add_argument('-y', type=float, default=25, help='Hero starting Y position')
    parser.add_argument('-z', type=float, default=8, help='Hero starting Z position')
